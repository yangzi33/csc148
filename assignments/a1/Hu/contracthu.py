...
class TermContract(Contract):
    ...
    def new_month(self, month: int, year: int, bill: Bill) -> None:
        ...
        if list(self._contract.items())[-1][0] == (self.start.month, self.start.year):
    ...
    def cancel_contract(self) -> float:
        ...
        contracts = list(self._contract.keys())
        if (contracts[-1][0] > self._end.month and
                contracts[-1][1] > self._end.year):
